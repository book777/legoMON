...
1	Скачайте понравившейся вам шаблон (http://rubukkit.org/threads/64742) и скопируйте папку template в папку скрипта (legoMON/)

2	Откройте config.php. Там вы увидите
...
3	Скопируйте стиль из template/style.css (идет вместе с шаблоном) в конец(!) вашего шаблона
		DLE - templates/Default/styles/style.css
		webMCR - style/system/css/design.css
	

4	Подключите мониторинг к cron (автоматическое выполнение)
...
5	Вставьте мониторинг в шаблон
